...
public class AutonomousBackwardForward extends SequentialCommandGroup {
  /**
   ...
   */
  public AutonomousBackwardForward(RobotContainer robotContainer) {
    ...
    new TurnDegreesGyroPID(0.7, 190, chassisSubsystem),
